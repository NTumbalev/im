...
class AccentsAdmin extends Admin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $translationAdmin = $this->configurationPool->getAdminByAdminCode('nt.accents.admin.accents_translation');
        ...
        $formMapper
            ->with('tab.general', array(
                ...
                ->with('form.general', array(
                    ...
                    ->add('translations', 'a2lix_translations', array(
                        ...
                        'exclude_fields' => array('buttonTitle', 'url', 'target'),
            ...
            ->with('Publish Workflow', array('tab' => true))
                ->with('Publish Workflow', array('class' => 'col-md-12', 'label' => 'form.general', 'translation_domain' => 'NTAccentsBundle'))
