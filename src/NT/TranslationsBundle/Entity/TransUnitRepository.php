...
use NT\TranslationsBundle\Entity\File as ModelFile;
...
class TransUnitRepository extends EntityRepository
{
    ...
    protected function loadCustomHydrator()
    {
        ...
        $config->addCustomHydrationMode('SingleColumnArrayHydrator', 'NT\TranslationsBundle\Util\Doctrine\SingleColumnArrayHydrator');
    }
}
