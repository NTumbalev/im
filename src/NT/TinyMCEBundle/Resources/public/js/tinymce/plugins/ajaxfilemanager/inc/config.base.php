...
//error_reporting(E_ALL & (~E_NOTICE));
	...
	define("CONFIG_LOGIN_USERNAME", false);
	define('CONFIG_LOGIN_PASSWORD', false);
	define('CONFIG_LOGIN_PAGE', 'ajax_no_auth.php'); //the url to the login page
	...
	define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,jpeg,png,bmp,tif,zip,rar,gz,tar,mov,mpg,avi,asf,mpeg,wmv,aif,aiff,wav,mp3,swf,ppt,rtf,doc,pdf,txt');// // 
    ...
    define('CONFIG_URL_PATH_ONLY', true);
